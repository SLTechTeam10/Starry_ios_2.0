...
//  BSLChatBot
//
//  Created by Pramanshu Goel on 01/04/20.
...
class NotificationListController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if (shouldAutoLoadNotificationsList) {
            ...
            let notificationsExist = (appdelegate.notificationListGlobal.count > 0)
    ...
    @objc func handleRefresh()  {
        ApprovalManager.shared.getNotification( completion: {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if(appdelegate.notificationListGlobal.count>0){
            return appdelegate.notificationListGlobal.count
        }
        return 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dict = appdelegate.notificationListGlobal[indexPath.row]
