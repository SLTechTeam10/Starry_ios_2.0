//
//  LNewsLetterListViewController.swift
//  BSLChatBot
//
//  Created by Shweta Singh on 14/02/22.
...
import CoreData
import Firebase
class LNewsLetterListViewController: UIViewController, NewsletterDetailDelegateProtocol,URLSessionTaskDelegate,URLSessionDataDelegate{
...
//    var categories = ["All","Business","Corporate","EHS","Finance","HR", "Law","Marketing","Service","StarTalk","Technology"]
    ...
    func sendUpdatedReadStatus(myData: [NewsletterModel]) {
       ...
       // newLetterListTblView.contentInsetAdjustmentBehavior = .never
       }
    ...
    override func viewDidLoad() {
        ...
        // experimental table view config for extra padding
        //newLetterListTblView.contentInsetAdjustmentBehavior = .never
...
//                let indexPath = IndexPath(item: rowIndex!, section: rowSection!)
            ...
            DispatchQueue.main.async {
                ...
                if let array = responseDictionary as? NSMutableArray,
                    ...
                    if (self.selectedNewsletterID != nil) {
                        ...
                        appdelegate.updateProspReadStatusNewsletter(id: self.selectedNewsletterID ?? "")
    ...
    @objc func processNewsletterResponse() {
        ...
        print("appdelegate.newsletterListGlobal",appdelegate.prospNewsletterListGlobal)
        print("appdelegate.newsletterUtilityGlobal",appdelegate.prospNewsletterUtilityGlobal)

        var newsLetterFromDatabase = convertToJSONArray(moArray: appdelegate.prospNewsletterListGlobal)
        let newsLetterUtilityFromDatabase = convertToJSONArray(moArray: appdelegate.prospNewsletterUtilityGlobal)
...
extension LNewsLetterListViewController {
...
extension LNewsLetterListViewController : UITableViewDataSource , UITableViewDelegate{
...
extension LNewsLetterListViewController : UISearchBarDelegate {
...
//
extension LNewsLetterListViewController: HeaderViewDelegate {
    
    func toggleSection(header: HeaderView, section: Int) {
        
        print("header view tapped section no : \(section)")
...
//        header.setCollapsed(collapsed: collapsed)
        ...
        newLetterListTblView.reloadData()
        //header.setCollapsed(collapsed: collapsed)
        //newLetterListTblView.reloadSections(NSIndexSet(index: section) as IndexSet, with: .none)
 ...
 */
extension LNewsLetterListViewController: UICollectionViewDataSource, UICollectionViewDelegate {
